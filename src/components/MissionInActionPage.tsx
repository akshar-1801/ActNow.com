...
// // For Vite, you might need to install and manually import framer-motion
...
//                     <motion.h1
//                         className="text-4xl md:text-5xl lg:text-6xl font-light text-green-900 mb-6 md:mb-0 font-merriweather"
...
//                         <Button variant="outline" className="text-green-900 hover:bg-green-900 hover:text-white border-2  px-4 py-3 text-lg font-raleway">
//                             Read More
//                         </Button>
//                     </div>
//                 </motion.div>
...
//                             >
//                                 <div
//                                     className="h-80 bg-gradient-to-b from-green-800 to-green-400 rounded-md"
//                                     style={{
